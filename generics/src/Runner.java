...
public class Runner {
    public static void main(String[] args) {
        ...
        //2
        PurchaseUtils<Purchase<Product, Integer>> pu1 = new PurchaseUtils<>(p1);
        pu1.printPurchase();
        pu1.printCost();
        //3
        Purchase<Product, Double> p2 = new Purchase<>(new Product("Sugar", new Byn(300)), 12.5);
        //4
        PurchaseUtils<Purchase<Product, Double>> pu2 = new PurchaseUtils<>(p2);
        pu2.printCost();
        ...
        Purchase<DiscountProduct, Integer> p3 = new Purchase<>(new DiscountProduct("Sugar", new Byn(280),
                new Byn(10)), 60);
        //6
        PurchaseUtils<Purchase<Service, Double>> pu4 = new PurchaseUtils<>(new Purchase<>(
