...
```
**Ответ.**  
Нет, тут используется try-with-resources применяющийся для создания и закрытия неких ресурсов.\  
**Источник**  
https://docs.oracle.com/javase/tutorial/essential/exceptions/tryResourceClose.html 
...
**Ответ.**  
При нечастом использовании проверяемые исключения могут повысить надежность программ. При злоупотреблении они делают использование API болезненным.\
**Источник**  
...
**Ответ.**  
Да, возможно отнаследоваться от класса `Throwable`. Данное исключение будет проверяемым.\
**Источник**  
